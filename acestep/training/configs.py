...
class LoKRConfig:
    ...
    bypass_mode: bool = True  # Enable bypass mode to preserve original output shape
    rs_lora: bool = False
    unbalanced_factorization: bool = False
    train_text_encoder: bool = False
    train_dit: bool = True
    train_text_encoder_only: bool = False # Deprecated, use train_text_encoder=True, train_dit=False
    use_fp8: bool = False
    ...
    def to_dict(self):
        ...
        return {
            ...
            "train_dit": self.train_dit,
            "train_text_encoder_only": self.train_text_encoder_only,
...
class TrainingConfig:
    ...
    Attributes:
        ...
        optimizer: Optimizer type ("adamw", "adamw8bit", "sgd", "lion", "prodigy")
        scheduler: Scheduler type ("cosine", "linear", "constant", "cosine_restarts")
    """
    ...
    optimizer: str = "adamw"  # Options: "adamw", "adamw8bit", "sgd", "lion", "prodigy"
    scheduler: str = "cosine"  # Options: "cosine", "linear", "constant", "cosine_restarts"
    ...
    def __post_init__(self) -> None:
        ...
        valid_optimizers = {"adamw", "adamw8bit", "sgd", "lion", "prodigy", "adam"}
        if self.optimizer not in valid_optimizers:
            raise ValueError(f"optimizer must be one of {valid_optimizers}, got '{self.optimizer}'")
        valid_schedulers = {"cosine", "linear", "constant", "cosine_restarts"}
