...
def _build_lokr_training_wrapper(
    ...
    def lokr_training_wrapper(
        ...
        lokr_train_text_encoder: Any,
        lokr_train_dit: Any,
        lokr_use_fp8: Any,
        lokr_target_modules: Any,
        lokr_full_matrix: Any,
        lokr_bypass_mode: Any,
        lokr_rs_lora: Any,
        lokr_unbalanced_factorization: Any,
        lokr_optimizer_type: Any,
    ...
    *,
    ...
    training_section["start_lokr_training_btn"].click(
        ...
        inputs=[
            ...
            training_section["lokr_train_text_encoder"],
            training_section["lokr_train_dit"],
            training_section["lokr_use_fp8"],
            training_section["lokr_target_modules"],
            training_section["lokr_full_matrix"],
            training_section["lokr_bypass_mode"],
            training_section["lokr_rs_lora"],
            training_section["lokr_unbalanced_factorization"],
            training_section["lokr_optimizer_type"],
